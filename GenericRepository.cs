...
namespace Techify.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class

    {
        DbSet<Tbl_Entity> _dbSet;
        private TechifyEntities _DBEntity;

        public GenericRepository(TechifyEntities DBEntity)
        {
        ...
        public void InactiveAndDeleteMarkedByWhereClause(Expression<Func<Tbl_Entity, bool>> wherePredict, Action<Tbl_Entity> ForEachPredict)
        {
